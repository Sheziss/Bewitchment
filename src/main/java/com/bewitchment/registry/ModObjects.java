...
public class ModObjects {
	...
	public static final ArmorMaterial ARMOR_COLD_IRON = EnumHelper.addArmorMaterial("cold_iron", Bewitchment.MODID + ":" + "cold_iron", 18, new int[]{2, 6, 7, 2}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0);
	public static final ArmorMaterial ARMOR_SILVER = EnumHelper.addArmorMaterial("silver", Bewitchment.MODID + ":" + "silver", 11, new int[]{2, 4, 5, 2}, 25, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0);

	public static final ToolMaterial TOOL_COLD_IRON = EnumHelper.addToolMaterial("cold_iron", 2, 425, 7, 2.5f, 14);
	public static final ToolMaterial TOOL_SILVER = EnumHelper.addToolMaterial("silver", 1, 131, 12, 1.5f, 22);
	...
	public static final Item cold_iron_boots = new ModItemArmor("cold_iron_boots", ARMOR_COLD_IRON, EntityEquipmentSlot.FEET);
	...
	public static final Item cold_iron_axe = new ModItemAxe("cold_iron_axe", TOOL_COLD_IRON);
	public static final Item cold_iron_spade = new ModItemSpade("cold_iron_spade", TOOL_COLD_IRON);
	public static final Item cold_iron_hoe = new ModItemHoe("cold_iron_hoe", TOOL_COLD_IRON);
	public static final Item silver_sword = new ModItemSword("silver_sword", TOOL_SILVER);
	public static final Item silver_pickaxe = new ModItemPickaxe("silver_pickaxe", TOOL_SILVER);
	public static final Item silver_axe = new ModItemAxe("silver_axe", TOOL_SILVER);
	public static final Item silver_spade = new ModItemSpade("silver_spade", TOOL_SILVER);
	public static final Item silver_hoe = new ModItemHoe("silver_hoe", TOOL_SILVER);
	...
	// Food
	public static final Item bowl_of_stew = new ItemBowlOfStew();
	...
	public static void preInit() {
		...
		for (Object obj : REGISTRY) {
			...
			if (obj instanceof Item) {
				...
				if (obj == ModObjects.grimoire_magia)
					Bewitchment.proxy.registerTextureWithVariant(item, Arrays.asList(s -> s.getDisplayName().equalsIgnoreCase("The Grimoire of Alice")));
