...
public class ModRecipes {
	...
	public static void preInitDistillery() {
		...
		BewitchmentAPI.REGISTRY_DISTILLERY.register(new DistilleryRecipe(Bewitchment.MODID, "swirl_of_the_depths", Arrays.asList(Ingredient.fromStacks(new ItemStack(ModObjects.coquina)), Ingredient.fromStacks(new ItemStack(Items.FISH)), Ingredient.fromStacks(new ItemStack(Items.DYE, 1, EnumDyeColor.BLUE.getDyeDamage())), Ingredient.fromStacks(new ItemStack(ModObjects.otherworldly_tears))), Arrays.asList(new ItemStack(Items.SLIME_BALL, 2), new ItemStack(ModObjects.swirl_of_the_depths)), 0, 900));
