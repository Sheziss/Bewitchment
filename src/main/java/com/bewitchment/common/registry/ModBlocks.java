...
import com.bewitchment.common.block.util.ModBlockDoor;
...
public class ModBlocks
{
	...
	//Devices
	public static final Block witches_altar = registerTileEntity("witches_altar", BlockWitchesAltar.class, TileEntityWitchesAltar.class);
