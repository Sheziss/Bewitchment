...
public class GuiHandler implements IGuiHandler {
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tile instanceof TileEntityApiary)
			return new GuiApiary((ContainerApiary) getServerGuiElement(ModGui.APIARY.ordinal(), player, world, x, y, z));
		if (tile instanceof TileEntityDistillery)
			return new GuiDistillery((ContainerDistillery) getServerGuiElement(ModGui.DISTILLERY.ordinal(), player, world, x, y, z));
		if (tile instanceof TileEntityLoom)
			return new GuiLoom((ContainerLoom) getServerGuiElement(ModGui.LOOM.ordinal(), player, world, x, y, z));
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tile instanceof TileEntityDistillery)
			return new ContainerDistillery(player.inventory, (TileEntityDistillery) tile);
