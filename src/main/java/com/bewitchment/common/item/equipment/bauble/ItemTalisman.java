...
public class ItemTalisman extends ModItemBauble {
	...
	public void onEquipped(ItemStack stack, EntityLivingBase living) {
		...
		for (Enchantment enchantment : EnchantmentHelper.getEnchantments(stack).keySet())
			if (enchantment instanceof ModEnchantment) ((ModEnchantment) enchantment).onEquipped(living);
	}

	@Override
	public void onUnequipped(ItemStack stack, EntityLivingBase living) {
		for (Enchantment enchantment : EnchantmentHelper.getEnchantments(stack).keySet())
			if (enchantment instanceof ModEnchantment) ((ModEnchantment) enchantment).onUnequipped(living);
	}
