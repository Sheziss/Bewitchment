...
public class ItemGirdleOfTheDryad extends ModItemBauble implements IRenderBauble {
	...
	public static ItemStack getGirdle(EntityPlayer player) {
		for (int i = 0; i < BaublesApi.getBaublesHandler(player).getSlots(); i++)
			if (BaublesApi.getBaublesHandler(player).getStackInSlot(i).getItem() instanceof ItemGirdleOfTheDryad)
				return BaublesApi.getBaublesHandler(player).getStackInSlot(i);
