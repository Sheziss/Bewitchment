...
public class ModItemSeed extends ItemSeeds implements IOreDictionaryContainer {
	private final List<String> oreDictionaryNames = new ArrayList<String>();

	public ModItemSeed(String name, Block crop, Block soil, String... oreDictionaryNames) {
		super(crop, soil);
