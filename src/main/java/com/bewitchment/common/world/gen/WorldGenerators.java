...
public class WorldGenerators implements IWorldGenerator {
	...
	public void generate(Random rand, int chunkX, int chunkZ, World world, IChunkGenerator generator, IChunkProvider provider) {
		if (world.provider instanceof WorldProviderSurface) {
			generateTree(world, rand, new WorldGenCypressTree(true), ModObjects.sapling_cypress, chunkX, chunkZ, Bewitchment.proxy.config.cypressChance, b -> BiomeDictionary.hasType(b, BiomeDictionary.Type.FOREST) && BiomeDictionary.hasType(b, BiomeDictionary.Type.COLD));
			...
			generateTree(world, rand, new WorldGenJuniperTree(true), ModObjects.sapling_juniper, chunkX, chunkZ, Bewitchment.proxy.config.juniperChance, b -> BiomeDictionary.hasType(b, BiomeDictionary.Type.SAVANNA));
