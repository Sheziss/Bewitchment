...
public class ModelRaven extends ModelBase {
	...
	public ModelRaven() {
		...
		this.ravenBeak2.setRotationPoint(0, 0, -3);
		this.ravenBeak2.addBox(-1, 0, 0, 2, 2, 3, 0);
		this.setRotateAngle(ravenBeak2, -0.2617993877991494F, 0, 0);
		this.tailRight = new ModelRenderer(this, 2, 21);
		this.tailRight.setRotationPoint(-1.5F, -2.0999999046325684F, 3);
		this.tailRight.addBox(-1, -0.5F, 0, 2, 1, 7, 0);
		this.wingRight3 = new ModelRenderer(this, 23, 24);
		this.wingRight3.mirror = true;
		this.wingRight3.setRotationPoint(-5.900000095367432F, 0, 1.100000023841858F);
		this.wingRight3.addBox(-5, -0.5899999737739563F, -1, 5, 1, 2, 0);
		this.ravenBodyTail = new ModelRenderer(this, 34, 39);
		this.ravenBodyTail.setRotationPoint(0, -1, 5.099999904632568F);
		this.ravenBodyTail.addBox(-2.5F, -4, 0, 5, 3, 3, 0);
		this.ravenBeak1b = new ModelRenderer(this, 42, 12);
		this.ravenBeak1b.setRotationPoint(0, 0, 0);
		this.ravenBeak1b.addBox(-1.100000023841858F, 0, -3, 1, 2, 3, 0);
		this.tail = new ModelRenderer(this, 2, 21);
		this.tail.setRotationPoint(0, -2.700000047683716F, 3);
		this.tail.addBox(-1, -0.5F, 0, 2, 1, 7, 0);
		this.wingLeft1 = new ModelRenderer(this, 0, 0);
		this.wingLeft1.setRotationPoint(3, -3, -4.699999809265137F);
		this.wingLeft1.addBox(0, -0.5F, 0, 5, 1, 4, 0);
		this.ravenLeftLeg1 = new ModelRenderer(this, 39, 1);
		this.ravenLeftLeg1.setRotationPoint(1.5F, -0.5F, 1);
		this.ravenLeftLeg1.addBox(-1, 0, 0, 2, 2, 2, 0);
		this.wingLeft2 = new ModelRenderer(this, 1, 11);
		this.wingLeft2.setRotationPoint(5, 0, 0);
		this.wingLeft2.addBox(0, -0.5899999737739563F, 0, 6, 1, 3, 0);
		this.ravenRightLeg2 = new ModelRenderer(this, 33, 8);
		this.ravenRightLeg2.mirror = true;
		this.ravenRightLeg2.setRotationPoint(0, 1.7999999523162842F, 1.5F);
		this.ravenRightLeg2.addBox(-0.5F, 0, -1, 1, 3, 1, 0);
		this.rumpRuff = new ModelRenderer(this, 19, 12);
		this.rumpRuff.setRotationPoint(0, -0.4000000059604645F, -0.20000000298023224F);
		this.rumpRuff.addBox(-2, -1.5F, 0, 4, 3, 3, 0);
		this.setRotateAngle(rumpRuff, -0.19198621771937624F, 0, 0);
		this.ravenBody = new ModelRenderer(this, 1, 30);
		this.ravenBody.setRotationPoint(0, 18.200000762939453F, 0);
		this.ravenBody.addBox(-3, -6, -5, 6, 6, 10, 0);
		this.ravenRightLeg3 = new ModelRenderer(this, 33, 3);
		this.ravenRightLeg3.mirror = true;
		this.ravenRightLeg3.setRotationPoint(0, 2.9000000953674316F, -1);
		this.ravenRightLeg3.addBox(-0.5F, 0, -2, 1, 1, 3, 0);
		this.ravenLeftLeg3 = new ModelRenderer(this, 33, 3);
		this.ravenLeftLeg3.setRotationPoint(0, 2.9000000953674316F, -1);
		this.ravenLeftLeg3.addBox(-0.5F, 0, -2, 1, 1, 3, 0);
		this.ravenRightLeg = new ModelRenderer(this, 39, 1);
		this.ravenRightLeg.mirror = true;
		this.ravenRightLeg.setRotationPoint(-1.5F, -0.5F, 1);
		this.ravenRightLeg.addBox(-1, 0, 0, 2, 2, 2, 0);
		this.ravenBeak1 = new ModelRenderer(this, 42, 12);
		this.ravenBeak1.setRotationPoint(0, -1, -5.199999809265137F);
		this.ravenBeak1.addBox(-0.8999999761581421F, 0, -3, 2, 2, 3, 0);
		this.setRotateAngle(ravenBeak1, 0.3490658503988659F, 0, 0);
		this.wingRight2 = new ModelRenderer(this, 1, 11);
		this.wingRight2.mirror = true;
		this.wingRight2.setRotationPoint(-5, 0, 0);
		this.wingRight2.addBox(-6, -0.5899999737739563F, 0, 6, 1, 3, 0);
		this.wingLeft1Feathers = new ModelRenderer(this, 0, 49);
		this.wingLeft1Feathers.setRotationPoint(0, 0, 4.099999904632568F);
		this.wingLeft1Feathers.addBox(0, 0.009999999776482582F, -1.100000023841858F, 5, 0, 7, 0);
		this.wingLeft3 = new ModelRenderer(this, 23, 24);
		this.wingLeft3.setRotationPoint(5.900000095367432F, 0, 1.100000023841858F);
		this.wingLeft3.addBox(0, -0.5899999737739563F, -1, 5, 1, 2, 0);
		this.feathers01 = new ModelRenderer(this, 36, 23);
		this.feathers01.setRotationPoint(0, 2.299999952316284F, -1.7999999523162842F);
		this.feathers01.addBox(-2, -1, -1, 4, 2, 4, 0);
		this.setRotateAngle(feathers01, -0.6981317007977318F, 0, 0);
		this.tailLeft = new ModelRenderer(this, 2, 21);
		this.tailLeft.setRotationPoint(1.5F, -2, 3);
		this.tailLeft.addBox(-1, -0.5F, 0, 2, 1, 7, 0);
		this.wingRight1Feathers = new ModelRenderer(this, 0, 49);
		this.wingRight1Feathers.mirror = true;
		this.wingRight1Feathers.setRotationPoint(0, 0, 4.099999904632568F);
		this.wingRight1Feathers.addBox(-5, 0.009999999776482582F, -1.100000023841858F, 5, 0, 7, 0);
		this.wingRight2Feathers = new ModelRenderer(this, 9, 49);
		this.wingRight2Feathers.mirror = true;
		this.wingRight2Feathers.setRotationPoint(0, -0, 1.5F);
		this.wingRight2Feathers.addBox(-6, 0.009999999776482582F, -1.5F, 6, 0, 10, 0);
		this.wingRight1 = new ModelRenderer(this, 0, 0);
		this.wingRight1.mirror = true;
		this.wingRight1.setRotationPoint(-3, -3, -4.699999809265137F);
		this.wingRight1.addBox(-5, -0.5F, 0, 5, 1, 4, 0);
		this.wingLeft2Feathers = new ModelRenderer(this, 9, 49);
		this.wingLeft2Feathers.setRotationPoint(0, -0, 1.5F);
		this.wingLeft2Feathers.addBox(0, 0, -1.5F, 6, 0, 10, 0);
		this.feathers02 = new ModelRenderer(this, 36, 30);
		this.feathers02.setRotationPoint(0, 2.0999999046325684F, 0.20000000298023224F);
		this.feathers02.addBox(-2.5F, -1, -1, 5, 2, 4, 0);
		this.setRotateAngle(feathers02, -0.6108652381980153F, 0, 0);
		this.ravenHead = new ModelRenderer(this, 42, 0);
		this.ravenHead.setRotationPoint(0, -1, -2);
		this.ravenHead.addBox(-2.5F, -2.5F, -5.599999904632568F, 5, 5, 6, 0);
		this.ravenNeck = new ModelRenderer(this, 48, 18);
		this.ravenNeck.setRotationPoint(0, -3.0999999046325684F, -3.799999952316284F);
		this.ravenNeck.addBox(-2, -2.5F, -3, 4, 5, 3, 0);
		this.ravenLeftLeg2 = new ModelRenderer(this, 33, 8);
		this.ravenLeftLeg2.setRotationPoint(0, 1.7999999523162842F, 1.5F);
		this.ravenLeftLeg2.addBox(-0.5F, 0, -1, 1, 3, 1, 0);
		this.wingLeft3Feathers = new ModelRenderer(this, 23, 49);
		this.wingLeft3Feathers.setRotationPoint(0, -0, 1.5F);
		this.wingLeft3Feathers.addBox(0, 0.01F, -2.5F, 12, 0, 10, 0);
		this.wingRight3Feathers = new ModelRenderer(this, 23, 49);
		this.wingRight3Feathers.mirror = true;
		this.wingRight3Feathers.setRotationPoint(0, -0, 1.5F);
		this.wingRight3Feathers.addBox(-12, 0.01F, -2.5F, 12, 0, 10, 0);
	...
	private void setFlyingStance() {
		...
		this.setRotateAngle(wingLeft2, 0, 0, 0.4363323129985824F);
		this.setRotateAngle(wingLeft3, 0, 0, 0.3490658503988659F);
		this.setRotateAngle(wingRight1, -0.08726646259971647F, 0F, -1.2217304763960306F);
		this.setRotateAngle(wingRight2, 0, 0, -0.4363323129985824F);
		this.setRotateAngle(wingRight3, 0, 0, -0.3490658503988659F);
		this.setRotateAngle(ravenLeftLeg1, 0.61086523819F, 0, 0);
		this.setRotateAngle(ravenLeftLeg2, 0, 0, 0);
		this.setRotateAngle(ravenLeftLeg3, 0.87266462599F, 0, 0);
		this.setRotateAngle(ravenRightLeg, 0.61086523819F, 0, 0);
		this.setRotateAngle(ravenRightLeg2, 0, 0, 0);
		this.setRotateAngle(ravenRightLeg3, 0.87266462599F, 0, 0);
	...
	private void setWanderingStance() {
		...
		this.setRotateAngle(tail, -0.15707963267948966F, 0, 0);
		this.setRotateAngle(wingLeft1, -0.03490658503988659F, -0.7853981633974483F, 0.5235987755982988F);
		this.setRotateAngle(ravenLeftLeg1, 0.41887902047863906F, 0, 0);
		this.setRotateAngle(wingLeft2, 0, -0.9948376736367678F, 0);
		this.setRotateAngle(ravenRightLeg2, -0.08726646259971647F, 0.03490658503988659F, 0);
		this.setRotateAngle(ravenBody, -0.6457718232379019F, 0, 0);
		this.setRotateAngle(ravenRightLeg3, 0.3141592653589793F, 0, 0);
		this.setRotateAngle(ravenLeftLeg3, 0.3141592653589793F, 0, 0);
		this.setRotateAngle(ravenRightLeg, 0.4363323129985824F, 0, 0);
		this.setRotateAngle(wingRight2, 0, 1.0122909661567112F, 0);
		this.setRotateAngle(wingLeft3, 0, -0.2617993877991494F, 0);
		...
		this.setRotateAngle(ravenHead, 0.6981317007977318F, 0, 0);
		this.setRotateAngle(ravenNeck, 0.2617993877991494F, 0, 0);
		this.setRotateAngle(ravenLeftLeg2, -0.08726646259971647F, -0.03490658503988659F, 0);
