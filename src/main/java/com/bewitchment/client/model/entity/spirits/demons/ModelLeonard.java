...
public class ModelLeonard extends ModelBase {
	...
	public ModelLeonard() {
		...
		this.lFoot.setRotationPoint(0.0F, 7.9F, 0.5F);
		this.lFoot.addBox(-1.5F, -0.5F, -2.4F, 3, 1, 3, 0.0F);
		this.setRotateAngle(lFoot, -0.017453292519943295F, -0.05235987755982988F, 0.0F);
		...
		this.bipedLeftArm.addBox(-1.0F, -2.0F, -2.0F, 3, 15, 4, 0.0F);
		...
		this.rLeg02.addBox(-1.5F, -0.1F, -1.5F, 3, 8, 3, 0.0F);
		this.setRotateAngle(rLeg02, 0.08726646259971647F, 0.0F, -0.06981317007977318F);
		...
		this.bipedRightArm.addBox(-2.0F, -2.0F, -2.0F, 3, 15, 4, 0.0F);
		...
		this.lLeg02.addBox(-1.5F, -0.1F, -1.5F, 3, 8, 3, 0.0F);
		this.setRotateAngle(lLeg02, 0.08726646259971647F, 0.0F, 0.06981317007977318F);
		...
		this.rFoot.setRotationPoint(0.0F, 7.8F, 0.5F);
		this.rFoot.addBox(-1.5F, -0.5F, -2.4F, 3, 1, 3, 0.0F);
		this.setRotateAngle(rFoot, -0.017453292519943295F, 0.05235987755982988F, 0.0F);
