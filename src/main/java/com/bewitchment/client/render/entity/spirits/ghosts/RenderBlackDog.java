...
public class RenderBlackDog extends RenderLiving<EntityBlackDog> {
	...
	private static class LayerEyes implements LayerRenderer<EntityBlackDog> {
		private static final ResourceLocation[] TEX = {
				new ResourceLocation(Bewitchment.MOD_ID, "textures/entity/black_dog_eyes_0.png"),
				new ResourceLocation(Bewitchment.MOD_ID, "textures/entity/black_dog_eyes_1.png"),
				new ResourceLocation(Bewitchment.MOD_ID, "textures/entity/black_dog_eyes_2.png"),
				new ResourceLocation(Bewitchment.MOD_ID, "textures/entity/black_dog_eyes_3.png"),
				new ResourceLocation(Bewitchment.MOD_ID, "textures/entity/black_dog_eyes_4.png")};
