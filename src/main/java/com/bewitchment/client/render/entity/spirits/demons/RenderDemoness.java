...
public class RenderDemoness extends RenderLiving<EntityDemoness> {
	private static final ResourceLocation[] TEX = {
			new ResourceLocation(Bewitchment.MODID, "textures/entity/demoness_0.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/demoness_1.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/demoness_2.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/demoness_3.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/demoness_4.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/demoness_5.png")};
