...
public class RenderSnake extends RenderLiving<EntitySnake> {
	private static final ResourceLocation[] TEX = {
			new ResourceLocation(Bewitchment.MODID, "textures/entity/snake_0.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/snake_1.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/snake_2.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/snake_3.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/snake_4.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/snake_5.png")};
	...
	protected ResourceLocation getEntityTexture(EntitySnake entity) {
		return TEX[entity.getDataManager().get(EntitySnake.SKIN)];
	}
