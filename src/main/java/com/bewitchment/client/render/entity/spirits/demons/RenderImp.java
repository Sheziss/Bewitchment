...
public class RenderImp extends RenderLiving<EntityImp> {
	private static final ResourceLocation[] TEX = {
			new ResourceLocation(Bewitchment.MODID, "textures/entity/imp_0.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/imp_1.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/imp_2.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/imp_3.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/imp_4.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/imp_5.png")};
