...
public class RenderToad extends RenderLiving<EntityToad> {
	private static final ResourceLocation[] TEX = {
			new ResourceLocation(Bewitchment.MODID, "textures/entity/toad_0.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/toad_1.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/toad_2.png"),
			new ResourceLocation(Bewitchment.MODID, "textures/entity/toad_3.png")};
