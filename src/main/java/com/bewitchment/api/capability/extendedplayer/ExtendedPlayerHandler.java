...
public class ExtendedPlayerHandler
{
	...
	{
		if (event.getEntityLiving() instanceof EntityPlayer && ((EntityPlayer) event.getEntityLiving()).getCapability(ExtendedPlayer.CAPABILITY, null).getTransformation() == null) event.getEntityLiving().getCapability(ExtendedPlayer.CAPABILITY, null).setTransformation(TransformationType.NONE);
	}
